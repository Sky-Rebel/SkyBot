...
import com.github.sky_rebel.bot.event.handling.dispatcher.OB11NoticeEventDispatcher;
import com.github.sky_rebel.bot.event.notice.OB11BotOfflineNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11FriendAddNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11FriendRecallNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupAdminNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupBanNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupCardNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupDecreaseNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupEssenceNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupIncreaseNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupNameNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupRecallNoticeEvent;
import com.github.sky_rebel.bot.event.notice.OB11GroupUploadNoticeEvent;
...
import com.github.sky_rebel.bot.event.notice.notify.OB11NotifyNoticeEvent;
	...
	public static void dispatch(Bot bot, JSONObject ob11EventPostData)
	{
		...
		switch (noticeEventType)
		{
			case FRIEND_ADD ->
			{
				...
				OB11NoticeEventDispatcher.onFriendAdded(bot, ob11FriendAddNoticeEvent);
			}
			case FRIEND_RECALL ->
			{
				...
				OB11NoticeEventDispatcher.onFriendMessageRecalled(bot, ob11FriendRecallNoticeEvent);
			}
			case GROUP_BAN ->
			{
				...
				if (subType.equals("ban"))
					OB11NoticeEventDispatcher.onGroupMemberMuted(bot, ob11GroupBanNoticeEvent);
				else if (subType.equals("lift_ban"))
					OB11NoticeEventDispatcher.onGroupMemberUnmuted(bot, ob11GroupBanNoticeEvent);
			...
			case GROUP_CARD ->
			{
				...
				OB11NoticeEventDispatcher.onGroupMemberCardUpdated(bot, ob11GroupCardNoticeEvent);
			}
			case GROUP_ADMIN ->
			{
				...
				if (subType.equals("set"))
					OB11NoticeEventDispatcher.onGroupAdminAssigned(bot, ob11GroupAdminNoticeEvent);
				else if (subType.equals("unset"))
					OB11NoticeEventDispatcher.onGroupAdminRevoked(bot, ob11GroupAdminNoticeEvent);
			}
			case GROUP_RECALL ->
			{
				...
				OB11NoticeEventDispatcher.onGroupMessageRecalled(bot, ob11GroupRecallNoticeEvent);
			}
			case GROUP_UPLOAD ->
			{
				...
				OB11NoticeEventDispatcher.onGroupFileUploaded(bot, ob11GroupUploadNoticeEvent);
			}
			case GROUP_DECREASE ->
			{
				...
				{
					case LEAVE -> OB11NoticeEventDispatcher.onGroupMemberKicked(bot, ob11GroupDecreaseNoticeEvent);
					case KICK -> OB11NoticeEventDispatcher.onGroupMemberKicked(bot, ob11GroupDecreaseNoticeEvent);
					case KICK_ME -> OB11NoticeEventDispatcher.onGroupBotKicked(bot, ob11GroupDecreaseNoticeEvent);
			...
			case GROUP_INCREASE ->
			{
				...
				if (subType.equals("approve"))
					OB11NoticeEventDispatcher.onGroupMemberApproved(bot, ob11GroupIncreaseNoticeEvent);
				else if (subType.equals("invite"))
					OB11NoticeEventDispatcher.onGroupMemberInvited(bot, ob11GroupIncreaseNoticeEvent);
			...
			case ESSENCE ->
			{
				...
				if (subType.equals("add"))
					OB11NoticeEventDispatcher.onGroupEssenceMessageAdded(bot, ob11GroupEssenceNoticeEvent);
				else if (subType.equals("delete"))
					OB11NoticeEventDispatcher.onGroupEssenceMessageRemoved(bot, ob11GroupEssenceNoticeEvent);
			...
			case BOT_OFFLINE ->
			{
				...
				OB11NoticeEventDispatcher.onBotOffline(bot, ob11BotOfflineNoticeEvent);
			}
			case NOTIFY ->
			{
				String subType = ob11EventPostData.getString("sub_type");
				...
				switch (notifyNoticeEventType)
				{
					case POKE ->
					{
						if (ob11EventPostData.has("group_id"))
						{
							...
							OB11NoticeEventDispatcher.onGroupPoke(bot, ob11GroupPokeNotifyNoticeEvent);
						}
						else
						{
							...
							OB11NoticeEventDispatcher.onFriendPoke(bot, ob11FriendPokeNotifyNoticeEvent);
						}
					}
					case TITLE ->
					{
						OB11GroupTitleNotifyNoticeEvent ob11GroupTitleNotifyNoticeEvent = new OB11GroupTitleNotifyNoticeEvent();
						ob11GroupTitleNotifyNoticeEvent.bot = bot;
						...
						OB11NoticeEventDispatcher.onGroupMemberTitleUpdated(bot, ob11GroupTitleNotifyNoticeEvent);
					}
					case INPUT_STATUS ->
					{
						OB11InputStatusNotifyNoticeEvent ob11InputStatusNotifyNoticeEvent = new OB11InputStatusNotifyNoticeEvent();
						ob11InputStatusNotifyNoticeEvent.bot = bot;
						...
						ob11InputStatusNotifyNoticeEvent.status_text = ob11EventPostData.getString("status_text");
						...
						OB11NoticeEventDispatcher.onFriendInputStatusUpdated(bot, ob11InputStatusNotifyNoticeEvent);
					}
					case PROFILE_LIKE ->
					{
						OB11ProfileLikeNotifyNoticeEvent ob11ProfileLikeNotifyNoticeEvent = new OB11ProfileLikeNotifyNoticeEvent();
						ob11ProfileLikeNotifyNoticeEvent.bot = bot;
						...
						OB11NoticeEventDispatcher.onProfileLikeNotify(bot, ob11ProfileLikeNotifyNoticeEvent);
					}
					case GROUP_NAME ->
					{
						...
						OB11NoticeEventDispatcher.onGroupNameUpdated(bot, ob11GroupNameNoticeEvent);
					}
				}
			}
		}
