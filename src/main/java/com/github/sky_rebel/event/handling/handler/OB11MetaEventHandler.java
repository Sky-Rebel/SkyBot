...
import com.github.sky_rebel.event.handling.dispatcher.OB11MateEventDispatcher;
import com.github.sky_rebel.event.meta.OB11HeartbeatEvent;
import com.github.sky_rebel.event.meta.OB11LifeCycleEvent;
...
public class OB11MetaEventHandler
{
	...
	public static void dispatch(Bot bot, JSONObject ob11EventPostData)
	{
		...
		if (metaEventType.equals(OB11LifeCycleEvent.META_EVENT_TYPE))
		{
			...
			{
				case ENABLE -> OB11MateEventDispatcher.onEnable(bot, ob11LifeCycleEvent);
				case DISABLE -> OB11MateEventDispatcher.onDisable(bot, ob11LifeCycleEvent);
				case CONNECT -> OB11MateEventDispatcher.onConnect(bot, ob11LifeCycleEvent);
		...
		else if (metaEventType.equals(OB11HeartbeatEvent.META_EVENT_TYPE))
		{
			...
			OB11MateEventDispatcher.onHeartbeat(bot, ob11HeartbeatEvent);
		}
