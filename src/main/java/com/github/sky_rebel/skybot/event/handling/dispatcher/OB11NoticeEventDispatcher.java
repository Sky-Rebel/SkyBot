	...
	public static void dispatch(Bot bot, JSONObject ob11EventPostData)
	{
		...
		switch (noticeType)
		{
			case FRIEND_ADD ->
			{
				...
				ob11FriendAddNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case FRIEND_RECALL ->
			{
				...
				ob11FriendRecallNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case GROUP_CARD ->
			{
				...
				ob11GroupCardNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case GROUP_ADMIN ->
			{
				...
				ob11GroupAdminNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case GROUP_RECALL ->
			{
				...
				ob11GroupRecallNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case GROUP_UPLOAD ->
			{
				...
				ob11GroupUploadNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case GROUP_DECREASE ->
			{
				...
				ob11GroupDecreaseNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case GROUP_INCREASE ->
			{
				...
				ob11GroupIncreaseNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case ESSENCE ->
			{
				...
				ob11GroupEssenceNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
			...
			case BOT_OFFLINE ->
			{
				...
				ob11BotOfflineNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
				...
				switch (notifyNoticeType)
				{
					case POKE ->
					{
						if (ob11EventPostData.has("group_id"))
						{
							...
							ob11GroupPokeNotifyNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
						...
						else
						{
							...
							ob11FriendPokeNotifyNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
					...
					case TITLE ->
					{
						...
						ob11GroupTitleNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
					...
					case INPUT_STATUS ->
					{
						...
						ob11InputStatusNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
					...
					case PROFILE_LIKE ->
					{
						...
						ob11ProfileLikeNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
					...
					case GROUP_NAME ->
					{
						...
						ob11GroupNameNoticeEvent.setBotId(ob11EventPostData.getLong("self_id"));
