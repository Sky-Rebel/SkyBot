...
import com.github.sky_rebel.skybot.event.handling.manage.OB11MessageEventManage;
...
public class OB11MessageEventHandler
{
	public static void onGroupMessage(Bot bot, OB11GroupMessageEvent ob11GroupMessageEvent)
	{
		...
		List<OB11MessageEventListener> ob11MessageEventListenerList = OB11MessageEventManage.getMessageEventListenerList();
		...
		List<OB11GroupMessageEventListener> ob11GroupMessageEventListenerList = OB11MessageEventManage.getGroupMessageEventListenerList();
	...
	public static void onPrivateMessage(Bot bot, OB11PrivateMessageEvent ob11PrivateMessageEvent)
	{
		...
		List<OB11PrivateMessageEventListener> ob11PrivateMessageEventListenerList = OB11MessageEventManage.getPrivateMessageEventListenerList();
