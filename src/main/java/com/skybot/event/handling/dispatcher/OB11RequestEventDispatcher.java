...
public class OB11RequestEventDispatcher
{
	...
	public static void onFriendRequest(OB11FriendAddRequestEvent ob11FriendAddRequestEvent)
	{
		...
		List<OB11FriendAddRequestEventListener> ob11FriendAddRequestEventListenerList = OB11RequestEventListenerManage.getOb11FriendAddRequestEventListenerList();
		ob11FriendAddRequestEventListenerList.forEach(ob11FriendAddRequestEventListener -> ob11FriendAddRequestEventListener.onFriendAddedRequest(ob11FriendAddRequestEvent));
	}
	...
	public static void onGroupAddRequest(OB11GroupAddRequestEvent ob11GroupAddRequestEvent)
	{
		...
		List<OB11GroupAddRequestEventListener> ob11FriendAddRequestEventListenerList = OB11RequestEventListenerManage.getOb11GroupAddRequestEventListenerList();
		ob11FriendAddRequestEventListenerList.forEach(ob11GroupAddRequestEventListener -> ob11GroupAddRequestEventListener.onGroupAddedRequest(ob11GroupAddRequestEvent));
	}
	...
	public static void onGroupInviteRequest(OB11GroupInviteRequestEvent ob11GroupInviteRequestEvent)
	{
		...
		List<OB11GroupInviteRequestEventListener> ob11GroupInviteRequestEventListenerList = OB11RequestEventListenerManage.getOb11GroupInviteRequestEventListenerList();
		ob11GroupInviteRequestEventListenerList.forEach(ob11GroupAddRequestEventListener -> ob11GroupAddRequestEventListener.onGroupInvitedRequest(ob11GroupInviteRequestEvent));
	}
}