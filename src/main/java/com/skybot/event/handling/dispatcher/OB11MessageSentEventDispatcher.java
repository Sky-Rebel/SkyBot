...
public class OB11MessageSentEventDispatcher
{
	 ...
	 */
	public static void onGroupSentMessage(OB11GroupMessageSentEvent ob11GroupMessageSentEvent)
	{
		...
		ob11MessageSentEventListenerList.forEach(ob11RequestEventListener -> ob11RequestEventListener.onGroupSentMessage(ob11GroupMessageSentEvent));
	}
	 ...
	 */
	public static void onPrivateSentMessage(OB11PrivateMessageSentEvent ob11PrivateMessageSentEvent)
	{
		List<OB11MessageSentEventListener> ob11MessageSentEventListenerList = OB11MessageSentEventListenerManage.getOb11MessageSentEventListenerList();
		ob11MessageSentEventListenerList.forEach(ob11RequestEventListener -> ob11RequestEventListener.onPrivateSentMessage(ob11PrivateMessageSentEvent));
	}
}
